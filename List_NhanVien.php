...
if (!empty($ds_nv)) {
    ...
    echo "<table border='1'>";
    echo "<tr><th>Mã NV</th><th>Tên NV</th><th>Giới tính</th><th>Nơi sinh</th><th>Mã phòng</th><th>Lương</th><th>Thao tác</th></tr>";
    foreach ($ds_nv as $nv) {
        echo "<tr>";
        echo "<td>" . $nv["Ma_NV"] . "</td>";
        ...
        echo "<td>";
        if ($nv["Phai"] == "NU") {
            echo "<img src='woman.jpg' alt='woman' width='20px' height='20px'>";
        } else {
            echo "<img src='man.jpg' alt='man' width='20px' height='20px'>";
        }
        echo "</td>";
        ...
        echo "<input type='hidden' name='ma_nv' value='" . $nv["Ma_NV"] . "'>";
